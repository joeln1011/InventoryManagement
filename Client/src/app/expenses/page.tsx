  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row justify-between gap-4">
        <div className="w-full md:w-1/3 bg-white shadow rounded-lg p-6 dark:bg-gray-700">
        ...
        {/* PIE CHART */}
        <div className="flex-grow bg-white shadow rounded-lg p-4 md:p-6 dark:bg-gray-700">
